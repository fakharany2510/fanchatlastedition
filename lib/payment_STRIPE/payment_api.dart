...
class StripeServices {
  ...
  static String secret =  PaymentConfig.mySecretKey; //todo 1
  ...
  static init() {
   StripePayment.setOptions(
        StripeOptions(
        publishableKey: PaymentConfig.myPublishKey, //todo 2
        androidPayMode: 'test',
        merchantId: 'test'));
  }
  ...
  static Future<StripeTransactionResponse> payNowHandler({required String amount, required String currency,required CreditCard testCard}) async {
    try {
