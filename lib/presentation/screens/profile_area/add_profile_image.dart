      ...
      builder: (context,state){
        return Scaffold(
          ...
          appBar:AppBar(
            ...
            actions: [
              state is ProfileUploadImagePostLoadingState || state is BrowiseGetPostsLoadingState?
              Center(child:CircularProgressIndicator(),)
                ...
                child: defaultButton(
                    ...
                    raduis: 10,
                    function: (){
                      if(AppCubit.get(context).profilePostImage == null){
                  ...
                  (AppCubit.get(context).profilePostImage!= null )
                    ...
                    child: Container(
                      ...
                      child: Align(
                        ...
                        child: Image(
                          image: FileImage(AppCubit.get(context).profilePostImage!),
