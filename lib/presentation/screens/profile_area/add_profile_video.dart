              ...
              state is BrowiseCreateVideoPostLoadingState||state is BrowiseGetPostsLoadingState || state is BrowiseUploadVideoPostLoadingState
                ...
                child: Center(
                  ...
                  CircularProgressIndicator(backgroundColor: AppColors.navBarActiveIcon,)
                      ...
                      raduis: 10,
                      function: (){
                        if(AppCubit.get(context).ProfilePostVideo == null){
          ...
          body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  ( AppCubit.get(context).ProfilePostVideo!= null && AppCubit.get(context).videoPlayerController!.value.isInitialized)
                      ?Expanded(
                    child: Container(
                      height: size.height,
                      width: size.width,
