...
class AntherChatDetails extends StatefulWidget {
  ...
  String ?userName;
  final onSendMessage;
  AntherChatDetails({required this.userName,required this.userId,required this.userImage,this.onSendMessage});
                ...
                return Scaffold(
                  ...
                  appBar: AppBar(
                    ...
                    title: Row(
                      ...
                      children: [
                        CircleAvatar(
                          backgroundImage:  NetworkImage('${widget.userImage!}') as ImageProvider,
                          radius: 22,
                        ),
