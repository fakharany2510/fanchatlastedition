...
class _ChatDetailsState extends State<ChatDetails> {
  ...
  Future uploadRecord(
    ...
    Reference storageReference =firebase_storage.FirebaseStorage.instance.ref().child('privateChatVoice/${AppCubit.get(context).userModel!.uId}/${Uri.file('${voice.path}').pathSegments.last}');
