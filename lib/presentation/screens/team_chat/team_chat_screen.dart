...
class _TeamChatScreenState extends State<TeamChatScreen> {
  ...
  Future uploadRecord(
    ...
    Reference storageReference =firebase_storage.FirebaseStorage.instance.ref().child('teamChatVoice/${widget.countryName}/${AppCubit.get(context).userModel!.uId}/${Uri.file('${voice.path}').pathSegments.last}');
