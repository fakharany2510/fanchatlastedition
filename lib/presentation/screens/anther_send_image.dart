...
class AntherSendImage extends StatefulWidget {
  ...
  String ?userImage;
  String ?userName;
  AntherSendImage(this.userId,this.userImage,this.userName);
  @override
      ...
      listener: (context,state){
        ...
        if(state is BrowiseUploadImagePostSuccessState){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_){
            return AntherChatDetails(userName: widget.userName, userId: widget.userId, userImage: widget.userImage);
          }));
        }
      },
